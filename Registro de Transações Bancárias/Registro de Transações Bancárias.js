    ...
    switch (opcao) {
      ...
      case 2:
        ...
        if (valorSaque <= contaBancaria.saldo) {
          // Subtraia o valor do saque do saldo da conta:
          contaBancaria.saldo -= valorSaque;
          // Imprima a confirmação do saque e o saldo atual formatado:
          print("Operação de saque concluída.");
          print(`Saldo atual: R$ ${contaBancaria.saldo.toFixed(2)}`);
        } else {
          // Se o saldo for insuficiente, imprima uma mensagem de erro e o saldo atual:
      ...
      case 3:
        // Imprima o saldo atual formatado:
        print(`Saldo atual: R$ ${contaBancaria.saldo.toFixed(2)}`);
        break;
